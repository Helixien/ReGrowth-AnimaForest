...
namespace AnimaForest
{
	...
	public static class Utils
	{
        ...
        {
			return pawn.RaceProps.IsFlesh && pawn.Map != null && (pawn.GetRoom()?.PsychologicallyOutdoors ?? false) && pawn.Map.weatherManager.CurWeatherPerceived == AF_DefOf.RG_PsychicFog;
		}

		public static bool IsAffectedByAnimaSoothe(this Pawn pawn)
		{
			return pawn.RaceProps.IsFlesh && pawn.Map != null && pawn.Map.gameConditionManager.ConditionIsActive(AF_DefOf.RG_AnimaSoothe);
		}
		...
		public static void DoAnimaWrath(Map map)
        {
			...
			{
				case 1: AddGameCondition(map, AF_DefOf.RG_PsychicStormGC, Rand.Range(GenDate.TicksPerHour * 2, GenDate.TicksPerHour * 3)); break;
				case 2: AddGameCondition(map, AF_DefOf.RG_PsychicFlareGC, Rand.Range(GenDate.TicksPerDay, GenDate.TicksPerDay * 3)); break;
				case 3: AddIncident(map, AF_DefOf.RG_PsychicShriek); break;
				case 4: AddIncident(map, AF_DefOf.RG_AnimalInsanityPulse); break;
			}
		}
